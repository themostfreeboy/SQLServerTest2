...
namespace SQLServerTest_2.dsTableAdapters {
    ...
    public partial class userinfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[userinfo] WHERE (([username] = @Original_username) AND ([userp" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userinfo] ([username], [userpassword]) VALUES (@username, @use" +
                "rpassword);\r\nSELECT username, userpassword FROM userinfo WHERE (username = @user" +
                "name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[userinfo] SET [username] = @username, [userpassword] = @userpasswor" +
                "d WHERE (([username] = @Original_username) AND ([userpassword] = @Original_userp" +
                "assword));\r\nSELECT username, userpassword FROM userinfo WHERE (username = @usern" +
                "ame)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLServerTest_2.Properties.Settings.Default.connectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT * FROM dbo.userinfo";
